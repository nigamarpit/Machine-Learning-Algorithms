...
subplot(3,2,1)
histogram(mse1,10)
title('g1(x)'),ylabel('Frequency'),xlabel('Mean Squared Error')
subplot(3,2,2)
histogram(mse2,10)
title('g2(x)'),ylabel('Frequency'),xlabel('Mean Squared Error')
subplot(3,2,3)
histogram(mse3,10)
title('g3(x)'),ylabel('Frequency'),xlabel('BiMean Squared Errorns')
subplot(3,2,4)
histogram(mse4,10)
title('g4(x)'),ylabel('Frequency'),xlabel('Mean Squared Error')
subplot(3,2,5)
histogram(mse5,10)
title('g5(x)'),ylabel('Frequency'),xlabel('Mean Squared Error')
subplot(3,2,6)
histogram(mse6,10)
title('g6(x)'),ylabel('Frequency'),xlabel('Mean Squared Error')
...
output = [{'Bias', 'Variance'}; [arrayfun(@num2str,bias2,'UniformOutput',false)',arrayfun(@num2str,variance,'UniformOutput',false)']]
end